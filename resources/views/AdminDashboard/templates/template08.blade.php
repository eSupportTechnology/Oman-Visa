    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="card-header">
                <h2>Passport Verification Form</h2>
            </div>
            <div class="card-body">
            ...
            <form action="{{ route('template08.generate') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="gender" id="gender" class="form-control" required>
                                <option value="Erkek (M)">Male (M)</option>
                                <option value="Kadın (F)">Female (F)</option>
                            </select>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <label for="old_issue_date" class="form-label">Old Passport Issue Date:</label>
                            <input type="date" name="old_issue_date" id="old_issue_date" class="form-control">
                        </div>
