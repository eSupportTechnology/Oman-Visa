...
<head>
    ...
    <link rel="stylesheet" href="{{ public_path('frontend/assets/css/bootstrap/css/bootstrap.min.css') }}">
<style>
...
<div class="document-container" id="document-container" style="
    ...
    <div class="row">
        <div class="col-sm-8">
            <img src="{{ public_path('Picture1.png') }}" alt="Turkish Logo" class="img-fluid" style="width:85%">
        </div>

        <div class="col-sm-4 text-right mt-4">
            <img src="{{ public_path('barcode.png') }}" alt="Barcode" class="img-fluid" style="width:300px; height:80px">
